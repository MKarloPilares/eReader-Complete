...
var RTGTransition = React11.forwardRef((_ref, ref) => {
  let {
    component: Component
...
var OffcanvasBody = React15.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var OffcanvasToggling = React16.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
...
var ModalContext = React17.createContext({
...
var AbstractModalHeader = React19.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
...
var divWithClassName_default = (className) => React21.forwardRef((p, ref) => (0, import_jsx_runtime18.jsx)("div", {
  ...p,
  ref,
...
var OffcanvasTitle = React22.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React23.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const renderBackdrop = (0, import_react27.useCallback)((backdropProps) => (0, import_jsx_runtime20.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React24.forwardRef((props, ref) => {
...
var NavbarText = React25.forwardRef(({
  className,
  bsPrefix,
  as: Component = "span",
  ...props
...
var Navbar = React26.forwardRef((props, ref) => {
  const {
...
//# sourceMappingURL=chunk-WII4QX6O.js.map
